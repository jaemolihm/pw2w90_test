...
if [ $# -eq 0 ]; then
  args="si si_scdm_erfc si_scdm_gaussian si_scdm_isolated benzene pt gaas gaas_nosoc col_fe_up col_fe_dn col_fe_paw_up col_fe_paw_dn fe unk_si unk_gaas unk_col_fe"
elif [ $1 == "scdm" ]; then
